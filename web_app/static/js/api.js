...
async function alterarReserva(reservaId, novaDataInicio, novaDataFim) {
    const corpo = {};
    if (novaDataInicio) corpo.data_inicio = novaDataInicio;
    if (novaDataFim) corpo.data_fim = novaDataFim;
